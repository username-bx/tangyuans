import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as i,o as t}from"./app-BrZsAzVA.js";const s={};function o(r,e){return t(),a("div",null,e[0]||(e[0]=[i(`<h1 id="修改衣服属性-增加配方" tabindex="-1"><a class="header-anchor" href="#修改衣服属性-增加配方"><span>修改衣服属性，增加配方</span></a></h1><h2 id="文件路径" tabindex="-1"><a class="header-anchor" href="#文件路径"><span>文件路径</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>~/Zomboid/mods/你的模组名字/</span></span>
